...
CREATE TABLE IF NOT EXISTS `message` (
  ...
  `attribute1` varchar(100) NULL DEFAULT NULL,
  `attribute2` varchar(100) NULL DEFAULT NULL,
  `attribute3` varchar(100) NULL DEFAULT NULL,
  `attribute4` varchar(100) NULL DEFAULT NULL,
  `attribute5` varchar(100) NULL DEFAULT NULL,
  `attribute6` varchar(100) NULL DEFAULT NULL,
  `attribute7` varchar(100) NULL DEFAULT NULL,
  `attribute8` varchar(100) NULL DEFAULT NULL,
  `attribute9` varchar(100) NULL DEFAULT NULL,
  `attribute10` varchar(100) NULL DEFAULT NULL,
  `attribute11` varchar(100) NULL DEFAULT NULL,
  `attribute12` varchar(100) NULL DEFAULT NULL,
  `attribute13` varchar(100) NULL DEFAULT NULL,
  `attribute14` varchar(100) NULL DEFAULT NULL,
  `attribute15` varchar(100) NULL DEFAULT NULL,
  `attribute16` varchar(100) NULL DEFAULT NULL,
  `attribute17` varchar(100) NULL DEFAULT NULL,
  `attribute18` varchar(100) NULL DEFAULT NULL,
  `attribute19` varchar(100) NULL DEFAULT NULL,
  `attribute20` varchar(100) NULL DEFAULT NULL,
  `created_by` int NOT NULL DEFAULT 1,
  `created_date` datetime NOT NULL,
  `updated_by` int NOT NULL DEFAULT 1,
  `updated_date` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `message_read_idx` (`read`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8mb4;
...
VALUES
  ...
  ('contactForm',3,'contactFormAttribute1',NULL,NULL,'Contact Form Field 1 Label','Display label for contact form custom field 1',1,now(),1,now()),
  ('contactForm',4,'contactFormAttribute2',NULL,NULL,'Contact Form Field 2 Label','Display label for contact form custom field 2',1,now(),1,now()),
  ('contactForm',5,'contactFormAttribute3',NULL,NULL,'Contact Form Field 3 Label','Display label for contact form custom field 3',1,now(),1,now()),
  ('contactForm',6,'contactFormAttribute4',NULL,NULL,'Contact Form Field 4 Label','Display label for contact form custom field 4',1,now(),1,now()),
  ('contactForm',7,'contactFormAttribute5',NULL,NULL,'Contact Form Field 5 Label','Display label for contact form custom field 5',1,now(),1,now()),
  ('contactForm',8,'contactFormAttribute6',NULL,NULL,'Contact Form Field 6 Label','Display label for contact form custom field 6',1,now(),1,now()),
  ('contactForm',9,'contactFormAttribute7',NULL,NULL,'Contact Form Field 7 Label','Display label for contact form custom field 7',1,now(),1,now()),
  ('contactForm',10,'contactFormAttribute8',NULL,NULL,'Contact Form Field 8 Label','Display label for contact form custom field 8',1,now(),1,now()),
  ('contactForm',11,'contactFormAttribute9',NULL,NULL,'Contact Form Field 9 Label','Display label for contact form custom field 9',1,now(),1,now()),
  ('contactForm',12,'contactFormAttribute10',NULL,NULL,'Contact Form Field 10 Label','Display label for contact form custom field 10',1,now(),1,now()),
  ('contactForm',13,'contactFormAttribute11',NULL,NULL,'Contact Form Field 11 Label','Display label for contact form custom field 11',1,now(),1,now()),
  ('contactForm',14,'contactFormAttribute12',NULL,NULL,'Contact Form Field 12 Label','Display label for contact form custom field 12',1,now(),1,now()),
  ('contactForm',15,'contactFormAttribute13',NULL,NULL,'Contact Form Field 13 Label','Display label for contact form custom field 13',1,now(),1,now()),
  ('contactForm',16,'contactFormAttribute14',NULL,NULL,'Contact Form Field 14 Label','Display label for contact form custom field 14',1,now(),1,now()),
  ('contactForm',17,'contactFormAttribute15',NULL,NULL,'Contact Form Field 15 Label','Display label for contact form custom field 15',1,now(),1,now()),
  ('contactForm',18,'contactFormAttribute16',NULL,NULL,'Contact Form Field 16 Label','Display label for contact form custom field 16',1,now(),1,now()),
  ('contactForm',19,'contactFormAttribute17',NULL,NULL,'Contact Form Field 17 Label','Display label for contact form custom field 17',1,now(),1,now()),
  ('contactForm',20,'contactFormAttribute18',NULL,NULL,'Contact Form Field 18 Label','Display label for contact form custom field 18',1,now(),1,now()),
  ('contactForm',21,'contactFormAttribute19',NULL,NULL,'Contact Form Field 19 Label','Display label for contact form custom field 19',1,now(),1,now()),
  ('contactForm',22,'contactFormAttribute20',NULL,NULL,'Contact Form Field 20 Label','Display label for contact form custom field 20',1,now(),1,now()),
