...
VALUES
  ...
  (3,2,'heroGuide','hero.html','hero.json',2,'PitonCMS Hero','A full width image hero','<p>A full width image hero</p>','A full width image hero',NULL,NULL,'https://unsplash.it/2001/1000',NULL,1,'2018-12-22 14:08:02',1,'2019-01-11 14:46:03'),
  (4,2,'typoGuide','text.html','text.json',1,'Typography','<p>This is an example of plain text</p>\r\n<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reiciendis sit provident quas quia deserunt, officiis repellendus vel praesentium esse eius iure perferendis sunt id fugiat quis nemo nobis incidunt? Ad temporibus sit impedit! Repudiandae, placeat dolore consequuntur ratione aspernatur qui veritatis a atque. Quasi delectus, numquam odit quisquam odio minus blanditiis rem fugiat voluptate quaerat quam magnam atque nam.</p>\r\n\r\n<h1>Heading 1</h1>\r\n<h2>Heading 2</h2>\r\n<h3>Heading 3</h3>\r\n<h4>Heading 4</h4>\r\n<h5>Heading 5</h5>\r\n<h6>Heading 6</h6>','<p>This is an example of plain text</p>\n<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Reiciendis sit provident quas quia deserunt, officiis repellendus vel praesentium esse eius iure perferendis sunt id fugiat quis nemo nobis incidunt? Ad temporibus sit impedit! Repudiandae, placeat dolore consequuntur ratione aspernatur qui veritatis a atque. Quasi delectus, numquam odit quisquam odio minus blanditiis rem fugiat voluptate quaerat quam magnam atque nam.</p>\n<h1>Heading 1</h1>\n<h2>Heading 2</h2>\n<h3>Heading 3</h3>\n<h4>Heading 4</h4>\n<h5>Heading 5</h5>\n<h6>Heading 6</h6>','This is an example of plain text Lorem ipsum dolor, sit',NULL,NULL,NULL,NULL,1,'2018-12-22 14:13:56',1,'2019-01-11 14:46:03'),
  (5,2,'galleryGuide','gallery.html','gallery.json',1,'Gallery Style Guide','A gallery of images.','<p>A gallery of images.</p>','A gallery of images.',NULL,NULL,NULL,NULL,1,'2018-12-22 14:19:28',1,'2019-01-11 14:46:03'),
  (6,2,'collectionGuide','collection.html','collection.json',1,'Collection Element','This is an element that requires a collection to be created and then selected from the dropdown below. This is for when you have data that needs summary/detail.','<p>This is an element that requires a collection to be created and then selected from the dropdown below. This is for when you have data that needs summary/detail.</p>','This is an element that requires a collection to be created',NULL,NULL,NULL,NULL,1,'2018-12-22 22:21:27',1,'2019-01-11 14:46:03'),
  (7,2,'imageGuide','image.html','image.json',1,'Image Element','For when you need to add an image element into a website. The image loading below is 600 x 400 px','<p>For when you need to add an image element into a website. The image loading below is 600 x 400 px</p>','For when you need to add an image element into a website.',NULL,NULL,'https://unsplash.it/1000/400',NULL,1,'2018-12-22 22:24:44',1,'2019-01-11 14:46:03'),
  (8,2,'videoGuide','video.html','video.json',1,'Video Element - Vimeo','For when you want to embed an external link that comes with its own embed code like an iframe that is used by both YouTube and Vimeo.\r\n\r\nThis is a Vimeo link using responsive settings from Vimeo.','<p>For when you want to embed an external link that comes with its own embed code like an iframe that is used by both YouTube and Vimeo.</p>\n<p>This is a Vimeo link using responsive settings from Vimeo.</p>','For when you want to embed an external link that comes with',NULL,NULL,NULL,'<iframe src=\"https://player.vimeo.com/video/259291697\" width=\"640\" height=\"360\" frameborder=\"0\" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>\r\n<p><a href=\"https://vimeo.com/259291697\">Travel Oregon - Only Slightly Exaggerated</a> from <a href=\"https://vimeo.com/suncreature\">Sun Creature Studio</a> on <a href=\"https://vimeo.com\">Vimeo</a>.</p>',1,'2018-12-22 22:27:38',1,'2019-01-11 14:46:03'),
  (9,2,'videoGuide','video.html','video.json',1,'Video Element - Youtube','This is a YouTube embed link.','<p>This is a YouTube embed link.</p>','This is a YouTube embed link.',NULL,NULL,NULL,'<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/Fllx5pzvfFQ\" frameborder=\"0\" allow=\"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>',1,'2018-12-22 22:33:55',1,'2019-01-11 14:46:03'),
  (10,3,'galleryGuide','gallery.html','gallery.json',1,'Piton Gallery','This page represents the default gallery page. A gallery will need to be created before this page can be created. Currently it is populated with images from Unsplash.','<p>This page represents the default gallery page. A gallery will need to be created before this page can be created. Currently it is populated with images from Unsplash.</p>','This page represents the default gallery page. A gallery',NULL,NULL,NULL,NULL,1,'2018-12-29 14:12:38',1,'2019-01-11 14:45:49'),
  (11,4,'videoGuide','video.html','video.json',1,'Style Guide for Video','This is how the video will appear.','<p>This is how the video will appear.</p>','This is how the video will appear.',NULL,NULL,NULL,'<iframe width=\"560\" height=\"315\" src=\"https://www.youtube-nocookie.com/embed/Y7RAqOaj_JE\" frameborder=\"0\" allow=\"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>',1,'2019-01-11 14:27:16',1,'2019-01-11 14:53:08');
...
VALUES
  ...
  ('site',2,'urlDomainName','example.com','','Domain Name','Do not include the http(s):// or a trailing slash. For use in generated sitemaps.',1,now(),1,now()),
  ('site',3,'urlScheme','http','select','URL Scheme','Select <code>http</code> or <code>https</code> (https requires additional server changes).',1,now(),1,now()),
  ('site',4,'dateFormat','mm/dd/yyyy','select','Date Format','Select date picker format to use across site.',1,now(),1,now()),
  ('site',5,'googleWebMaster','Unique GWM Key',NULL,'Google Webmaster Verification Link',NULL,1,now(),1,now()),
  ('site',6,'googleAnalytics','Google Analytics Tracking Code',NULL,'Google Analytics Code',NULL,1,now(),1,now()),
  ('site',7,'statCounter','Stat counter code',NULL,'Stat Counter',NULL,1,now(),1,now()),
  ('contact',1,'displayName','Moritz Media',NULL,'Display Name',NULL,1,now(),1,now()),
  ('contact',2,'telephone','555-1212',NULL,'Telephone',NULL,1,now(),1,now()),
  ('contact',3,'mobile','541-555-1212',NULL,'Mobile',NULL,1,now(),1,now()),
  ('contact',4,'address1','Building 4',NULL,'Address Line 1',NULL,1,now(),1,now()),
  ('contact',5,'address2','1234 Main St',NULL,'Address Line 2',NULL,1,now(),1,now()),
  ('contact',6,'address3','Flat 13',NULL,'Address Line 3',NULL,1,now(),1,now()),
  ('contact',7,'city','Bend',NULL,'City',NULL,1,now(),1,now()),
  ('contact',8,'province','OR',NULL,'State',NULL,1,now(),1,now()),
  ('contact',9,'postalCode','TW1 2HU',NULL,'Postal Code',NULL,1,now(),1,now()),
  ('contact',10,'country','United States',NULL,'Country',NULL,1,now(),1,now()),
