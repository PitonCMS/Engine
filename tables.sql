...
VALUES
  ...
  (10,3,'galleryGuide','gallery.html','gallery',1,'Piton Gallery','This page represents the default gallery page. A gallery will need to be created before this page can be created. Currently it is populated with images from Unsplash.','<p>This page represents the default gallery page. A gallery will need to be created before this page can be created. Currently it is populated with images from Unsplash.</p>','This page represents the default gallery page. A gallery',NULL,NULL,NULL,NULL,1,'2018-12-29 14:12:38',1,'2019-01-11 14:45:49'),
